...
if __name__ == "__main__":
    ...
    date0 = (datetime.now() - timedelta(2)).strftime('%Y%m%d')  # 昨天
    print(date0)
    ...
    featcol, linear_featcols, dnn_featcols = gen_feat_wnd(column_dict)

    print("linear_featcol",linear_featcols)
    print("dnn_feat",dnn_featcols)
    ...
    if mode == "local":
        ...
        train_files = getFileList("data/eoe_train/")

        test_files = getFileList("data/eoe_test/")
