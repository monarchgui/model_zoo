...
if __name__ == "__main__":
    ...
    #
    # predict = estimator.predict(input_fn=read_dataset(check_files, configMap, decode_col, default_type, decode_col_idx, tf.estimator.ModeKeys.PREDICT))
    # dic_a = {}
    # dic_b = {}
    # dic_c = {}
    # dic_d = {}
